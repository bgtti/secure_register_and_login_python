...
# from app.routes.admin.schemas import admin_users_table_schema, admin_user_information, admin_user_logs_schema, admin_user_messages_schema,admin_user_flag_change,admin_user_access_type_change, admin_block_and_unblock_user_schema, admin_delete_user_schema
...
# ----- ADMIN DASHBOARD -----
# @admin.route("/admin_dashboard", methods=["POST"])
# def admin_dashboard():
#     # ...
#     return jsonify({'response': '...'})

# ----- USERS TABLE -----
# @admin.route("/users/users_table", methods=["POST"])
...
# ----- USER INFO -----
# @admin.route("/get_user/user_info", methods=["POST"])
# @login_required
# @admin_only
...
# # ----- USER LOGS -----
# @admin.route("/get_user/user_logs", methods=["POST"])
# @login_required
# @admin_only
...
# # ----- USER MESSAGES -----
# @admin.route("/get_user/user_messages", methods=["POST"])
# @login_required
# @admin_only
...
# @admin.route("/action/flag_change", methods=["POST"])
# @login_required
# @admin_only
...
# @admin.route("/action/access_change", methods=["POST"])
# @login_required
# @admin_only
...
# @admin.route("/action/block_unblock", methods=["POST"])
# @login_required
# @admin_only
...
# # ----- ACTION: DELETE USER -----
# @admin.route("/action/delete", methods=["POST"])
# @login_required
# @admin_only
