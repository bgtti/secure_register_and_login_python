...
# from app.common.constants.enum_class import TokenPurpose
# from app.extensions.extensions import db
# from app.extensions.sqlalchemy_config import EncryptedType, UTCDateTime
# from app.common.constants.enum_class import modelBool
...
#     # token status
#     token_verified = db.Column(db.Boolean, default=False, nullable=False) # user used the token 
...
#         return value
    ...
    # method bellow is now a service
